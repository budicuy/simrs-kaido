    ...
    <main>
        ...
        <div class="card">
            <div class="top-bar">
                ...
                <button class="filter-btn" style="display: none;"><img src="{{ asset('image/logo.svg') }}" alt="Logo RS"><span class="logo_name"><h5>RUMAH SAKIT ISLAM<br>BANJARMASIN</h5></span></div>Input.svg" alt=""></button>
            </div>
